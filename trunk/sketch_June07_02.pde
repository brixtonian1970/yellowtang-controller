...
//WIP :       --
//FUTURE:     menus, relays, buttons, servo motor for pumps, alarms, water change
//*************************************************************
...
#include <EEPROM.h>//#include <Bounce.h>
#include <math.h>
...
String CurrentDate; //Defines today's date
String ShortCurrentDate;
String CurrentTime; //Defines actual Time
...
{//BEGIN LOOP BRACKET
  ...
  currentTemp = TempLM35(); //read from LM35
    ...
    //**** LevelControl ****/
  //Read LevelControl value
  currentLevelControl = analogRead(LevelControl);
